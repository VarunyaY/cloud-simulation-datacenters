...
Simulation 3 - RoundRobin VM Allocation Policy, Cloudlet TimeShared and Cloudlet Full Utilization model

Objective: To check the difference between CloudletTimeShared and CloudletSpaceShared policies.
